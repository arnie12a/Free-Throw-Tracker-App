            ...
            <main className="w-full h-screen flex self-center place-content-center place-items-center">
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl bg-zinc-800">
                    <div className="text-center">
                        <div className="mt-2">
                            <h3 className="text-gray-50 text-xl font-semibold sm:text-2xl">Login to Your Account</h3>
                        </div>
                    </div>
                    <form
                        onSubmit={onSubmit}
                    ...
                    <p className="text-center text-sm text-white">
                        ...
                        <Link to={'/register'} className="hover:underline font-bold text-blue-500">
                            Sign up
                        </Link>
                    </p>
                    ...
                    <button
                        ...
                        className={`w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg text-sm font-medium bg-gray-400 ${isSigningIn ? 'cursor-not-allowed' : 'hover:bg-gray-100 transition duration-300 active:bg-gray-200'}`}>
